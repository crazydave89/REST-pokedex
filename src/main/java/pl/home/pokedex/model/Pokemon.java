...
public class Pokemon {
    ...
    public Pokemon(int id, String num, String name, String img, List<String> type,
                   String height, String weight, String candy, int candy_count,
                   String egg, double spawn_chance, int avg_spawns, String spawn_time,
                   List<Double> multipliers, List<String> weaknesses,
                   List<Next_Evolution> next_evolution, List<Prev_Evolution> prev_evolution) {
        this.id = id;
        this.num = num;
        this.name = name;
        this.img = img;
    ...
    public List<Prev_Evolution> getPrev_evolution() {
        return prev_evolution;
    }

    public void setPrev_evolution(List<Prev_Evolution> prev_evolution) {
        this.prev_evolution = prev_evolution;
    }
}
